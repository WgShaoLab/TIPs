...
def main() -> None:
    ...
    epilog = textwrap.dedent(
        ...
        Examples:
          ./run_denovo_tool_batch_final.py --tool all --input /data/mgf/*.mgf --outdir out --sample S1
          ./run_denovo_tool_batch_final.py --tool casanovo --input a.mgf b.mgf --outdir out --sample S1
          ./run_denovo_tool_batch_final.py --tool all --input /data/mgf/*.mgf --outdir out --sample S1 --gpu -1
        """
    )
